    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-lg flex overflow-hidden">
        ...
        <div className="w-1/2 bg-teal-500 text-white flex flex-col justify-center items-center p-10">
          <h1 className="text-3xl font-bold mb-4">Seja bem-vindo ao websocket-chat</h1>
          <p className="text-center text-sm mb-6">
            Já possui uma conta? <br />
            Faça login para continuar.
          </p>
          <Link href="/login">
            <button className="mt-4 w-full bg-white text-teal-500 border border-teal-500 hover:bg-teal-500 hover:text-white font-bold py-2 px-4 rounded-md transition">
              Login
            </button>
          </Link>
        </div>
        ...
        <div className="w-1/2 p-10">
          <h1 className="text-2xl font-bold mb-6 text-center text-teal-600">Registro</h1>
